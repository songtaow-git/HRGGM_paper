...
- Data and archived fitted results: [`Data_HRGGM_paper.zip` on Zenodo][zenodo-data] (draft preview)

The GitHub repository and the data archive are versioned separately. For reproducibility, report both the GitHub commit or release and the Zenodo record version used in an analysis. After the Zenodo record is published, replace the draft-preview link below with its permanent DOI URL.

[zenodo-data]: https://zenodo.org/records/22217595?preview=1&token=eyJhbGciOiJIUzUxMiJ9.eyJpZCI6IjMwZjVkZTQ3LTAxMzYtNDEyNy04ODllLTUzZTRkNjQ5ZTU2MiIsImRhdGEiOnt9LCJyYW5kb20iOiI5NmU1MTNhMGQyNjA3ZTNlY2NhNzhkNTgzYzliNmQ0MSJ9.4h8NHWIfglk8OPAE7i7CWuAb8tDwtuTK2Bnncz2Y7SdJj_6rkwYNO_lcI6AqRKLJzzje_dmQGqy6YtR--EteSg
